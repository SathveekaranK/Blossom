    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm flex items-center gap-5 group hover:border-gray-300 transition-colors">
                    <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-dark">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm flex items-center gap-5 group hover:border-gray-300 transition-colors">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm flex items-center gap-5 group hover:border-gray-300 transition-colors">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm flex items-center gap-5 group hover:border-gray-300 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 text-dark">
                            <BarChart3 className="w-5 h-5" />
                        </div>
                    </div>
                    {topSelling.length === 0 ? (
                        <p className="text-sm font-medium text-muted bg-gray-50 p-6 rounded-2xl text-center">No sales data available yet.</p>
                    ) : (
                ...
                <div className="flex flex-col gap-8">
                    {/* Low Stock Alerts */}
                    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                        ...
                        {lowStockProducts.length === 0 ? (
                            <p className="text-sm font-medium text-muted bg-gray-50 p-6 rounded-2xl text-center">All products are well stocked.</p>
                        ) : (
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {categoryData.map((cat, i) => (
                                <div key={i} className="flex gap-4 items-center p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                    <div className="w-12 h-12 relative flex items-center justify-center bg-white rounded-xl shadow-sm border border-gray-100 flex-shrink-0">
